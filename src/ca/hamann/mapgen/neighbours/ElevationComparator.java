...
public class ElevationComparator implements Comparator {
  ...
  public int compare(Object o1, Object o2) {
    ...
    //    if (elevation1 == elevation2) {
    //      int pseudoElev1 = tectMap.getPseudoElevation((SinusoidalLocation) o1);
    //      int pseudoElev2 = tectMap.getPseudoElevation((SinusoidalLocation) o2);
    //
